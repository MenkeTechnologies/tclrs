...
**1655 of 5055 attempted cases pass — 32.7%.** Over every case the suite contains, including the ones that cannot be run here, that is 1655 of 10046 — 16.5%.
...
| Skipped — cannot be run | 4991 | 49.7% |
| Attempted | 5055 | 50.3% |
| ⤷ passed | 1655 | 32.7% of attempted |
| ⤷ failed | 3400 | 67.3% of attempted |
...
| tclrs raised an error, the reference did not | 553 | "…" outside of a procedure is not supported |
...
**It gets 2 of 65 statements in, and stops at line 14 of the file.** That statement was refused:
...
| `unknown namespace in import pattern "…"` | 1 |
...
| `textDisp.test` | 397 | 330 | 67 | 34 | 50.7% |
