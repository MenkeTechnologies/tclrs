...
/// Extension opcode ids owned by this module. 35 and 38 are free in
/// `compiler::ext`: 33 and 34 are `LAPPEND_VAR`/`LAPPEND_SLOT`, 29–32 are
/// `foreach`, and 40 upwards is the bitwise block.
pub mod ext {
