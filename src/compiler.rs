...
pub mod ext {
    ...
    /// rejects `Op::Extended`.
    pub const BIT_AND: u16 = 33;
    pub const BIT_OR: u16 = 34;
    pub const BIT_XOR: u16 = 35;
    pub const SHL: u16 = 36;
    pub const SHR: u16 = 37;
    pub const BIT_NOT: u16 = 38;
...
impl Compiler {
    ...
    fn yields_integer(e: &Expr) -> bool {
        match e {
            Expr::Int(_) => true,
            Expr::Float(_) | Expr::Subst(_) => false,
