...
/// Extension opcode ids owned by this module. The compiler's own ids stop well
/// below `BASE`.
pub mod ext {
    pub const BASE: u16 = 100;
...
/// Whether an extension op belongs to this module.
pub(crate) fn owns(id: u16) -> bool {
    id >= ext::BASE
}
