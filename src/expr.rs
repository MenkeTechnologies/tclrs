...
impl<'a> ExprParser<'a> {
    ...
    fn parse_call(&mut self) -> Result<Expr, ParseError> {
        ...
        //
        // The spelling travels with the value, as it does for a digit literal:
        // `eq` and the other always-string operators compare what the script
        // wrote, and `Inf` written `inf` is two strings and one number.
