...
**29229 of 48324 attempted cases pass — 60.5%.** Over every case the suite
contains, including the ones that cannot be run here, that is 29229 of 69424 —
42.1%. [`conformance/REPORT.md`](conformance/REPORT.md) has the breakdown behind
...
After it, 29229 of 48324 pass — 60.5% — with 21100 skipped and 2686 of those for
a missing command. So the denominator grew by 16,800 *and* the share rose 20.1
...
tclsh has not got, no reference outcome) to 2686 / 13663 / 4751 / 0 — the two
