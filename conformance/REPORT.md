...
**2249 of 5066 attempted cases pass — 44.4%.** Over every case the suite contains, including the ones that cannot be run here, that is 2249 of 69424 — 3.2%.
...
| Attempted | 5066 | 7.3% |
| ⤷ passed | 2249 | 44.4% of attempted |
| ⤷ failed | 2817 | 55.6% of attempted |

Of the 2817 failures, 1538 are a feature tclrs documents as not built yet rather than a wrong answer. Counting those as skips instead would give 2249 of 3528 — 63.7% — and that looser number is stated here only so the choice of rule is visible. The headline above uses the strict rule.
...
| results differ | 56 | 2.0% | `append.test` append-3.4, `append.test` append-3.5, `append.test` append-3.6 |
...
| `expr.test` | 2168 | 1100 | 1068 | 433 | 635 | 40.5% |
